...
pptx_path = os.path.normpath("C:/Users/User/cre-dealcard/docs/test/golden-outputs/p2-sinsa-r3/income_captures/sinsa_income.pptx")
output_dir = os.path.normpath("C:/Users/User/cre-dealcard/docs/test/golden-outputs/p2-sinsa-r3/income_captures")
base_name = "sinsa_income"
dpi = 150
