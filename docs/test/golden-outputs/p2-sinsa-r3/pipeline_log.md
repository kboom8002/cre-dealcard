...
- **실행 일시**: 2026-09-20T23:55:08.496Z
- **매물명**: 신사동 590 ICL빌딩
- **포스처**: 매매차익형 (trading)
- **매각 희망가**: 760억 원
- **생성 슬라이드 면수**: 7면
...
| Step 6 | PPTX 렌더링 | **PASS** | 크기: 3021KB, 면수: 7면 (경고 0건) |
...
- **Slide 2**: `C:\Users\User\cre-dealcard\docs\test\golden-outputs\p2-sinsa-r3\captures\sinsa_basic_slide_02.png` (110 KB)
- **Slide 3**: `C:\Users\User\cre-dealcard\docs\test\golden-outputs\p2-sinsa-r3\captures\sinsa_basic_slide_03.png` (793 KB)
- **Slide 4**: `C:\Users\User\cre-dealcard\docs\test\golden-outputs\p2-sinsa-r3\captures\sinsa_basic_slide_04.png` (1360 KB)
- **Slide 5**: `C:\Users\User\cre-dealcard\docs\test\golden-outputs\p2-sinsa-r3\captures\sinsa_basic_slide_05.png` (83 KB)
