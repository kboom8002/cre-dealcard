...
pptx_path = os.path.normpath("C:/Users/User/cre-dealcard/docs/test/golden-outputs/p3-seocho-r3/captures/seocho_basic.pptx")
output_dir = os.path.normpath("C:/Users/User/cre-dealcard/docs/test/golden-outputs/p3-seocho-r3/captures")
base_name = "seocho_basic"
dpi = 150
