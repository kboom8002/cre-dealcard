...
pptx_path = os.path.normpath("C:/Users/User/cre-dealcard/docs/test/golden-outputs/p3-seocho-r3/trading_captures/seocho_trading.pptx")
output_dir = os.path.normpath("C:/Users/User/cre-dealcard/docs/test/golden-outputs/p3-seocho-r3/trading_captures")
base_name = "seocho_trading"
dpi = 150
