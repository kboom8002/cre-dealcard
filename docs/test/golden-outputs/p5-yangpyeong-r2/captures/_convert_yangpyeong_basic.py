...
pptx_path = os.path.normpath("C:/Users/User/cre-dealcard/docs/test/golden-outputs/p5-yangpyeong-r2/captures/yangpyeong_basic.pptx")
output_dir = os.path.normpath("C:/Users/User/cre-dealcard/docs/test/golden-outputs/p5-yangpyeong-r2/captures")
