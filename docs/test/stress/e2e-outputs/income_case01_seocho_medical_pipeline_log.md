...
**Generated**: 2026-09-17T08:53:34.420Z
**Total Duration**: 4.4s
...
|---|------|----------|--------|---------|
| 1 | ① SSoT Lite 구축 | 0.02s | ✅ success | buildingId: stress-case-01 |
| 2 | ② 바텀시트 보강 | 0.03s | ✅ success | posture: income, keys: 7 |
| 3 | ③ IM 생성 (LLM) | 0.66s | ✅ success | ok=true, sections=13, grade=B |
| 4 | ④ 중간 결과물 저장 | 0.05s | ✅ success | sections: 13 |
| 5 | ⑤ PPTX 렌더링 | 3.65s | ✅ success | slides: 15, size: 623KB |
