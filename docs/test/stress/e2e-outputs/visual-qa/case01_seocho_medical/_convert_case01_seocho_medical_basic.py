...
pptx_path = os.path.normpath("C:/Users/User/cre-dealcard/docs/test/stress/e2e-outputs/visual-qa/case01_seocho_medical/case01_seocho_medical_basic.pptx")
output_dir = os.path.normpath("C:/Users/User/cre-dealcard/docs/test/stress/e2e-outputs/visual-qa/case01_seocho_medical")
base_name = "case01_seocho_medical_basic"
dpi = 150
