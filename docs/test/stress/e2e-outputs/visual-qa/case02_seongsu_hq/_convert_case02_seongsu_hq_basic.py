...
pptx_path = os.path.normpath("C:/Users/User/cre-dealcard/docs/test/stress/e2e-outputs/visual-qa/case02_seongsu_hq/case02_seongsu_hq_basic.pptx")
output_dir = os.path.normpath("C:/Users/User/cre-dealcard/docs/test/stress/e2e-outputs/visual-qa/case02_seongsu_hq")
base_name = "case02_seongsu_hq_basic"
dpi = 150
