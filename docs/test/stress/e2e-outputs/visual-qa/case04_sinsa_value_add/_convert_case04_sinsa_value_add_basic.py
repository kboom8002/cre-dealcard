...
pptx_path = os.path.normpath("C:/Users/User/cre-dealcard/docs/test/stress/e2e-outputs/visual-qa/case04_sinsa_value_add/case04_sinsa_value_add_basic.pptx")
output_dir = os.path.normpath("C:/Users/User/cre-dealcard/docs/test/stress/e2e-outputs/visual-qa/case04_sinsa_value_add")
base_name = "case04_sinsa_value_add_basic"
dpi = 150
