...
pptx_path = os.path.normpath("C:/Users/User/cre-dealcard/docs/test/stress/e2e-outputs/visual-qa/case05_icheon_logistics/case05_icheon_logistics_basic.pptx")
output_dir = os.path.normpath("C:/Users/User/cre-dealcard/docs/test/stress/e2e-outputs/visual-qa/case05_icheon_logistics")
base_name = "case05_icheon_logistics_basic"
dpi = 150
