...
pptx_path = os.path.normpath("C:/Users/User/cre-dealcard/docs/test/stress/e2e-outputs/visual-qa/case06_yongsan_mixed/case06_yongsan_mixed_basic.pptx")
output_dir = os.path.normpath("C:/Users/User/cre-dealcard/docs/test/stress/e2e-outputs/visual-qa/case06_yongsan_mixed")
base_name = "case06_yongsan_mixed_basic"
dpi = 150
