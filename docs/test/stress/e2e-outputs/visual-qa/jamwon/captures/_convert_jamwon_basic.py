...
pptx_path = os.path.normpath("C:/Users/User/cre-dealcard/docs/test/stress/e2e-outputs/visual-qa/jamwon/captures/jamwon_basic.pptx")
output_dir = os.path.normpath("C:/Users/User/cre-dealcard/docs/test/stress/e2e-outputs/visual-qa/jamwon/captures")
base_name = "jamwon_basic"
dpi = 150
