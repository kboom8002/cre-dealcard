...
pptx_path = os.path.normpath("C:/Users/User/cre-dealcard/docs/test/stress/e2e-outputs/visual-qa/yangpyeong/captures/yangpyeong_basic.pptx")
output_dir = os.path.normpath("C:/Users/User/cre-dealcard/docs/test/stress/e2e-outputs/visual-qa/yangpyeong/captures")
base_name = "yangpyeong_basic"
dpi = 150
