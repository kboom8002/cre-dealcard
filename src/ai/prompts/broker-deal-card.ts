...
- "kakaoText": 카톡 전송용 3줄. 실제 중개인이 매수자에게 보내는 것처럼 간결하고 직접적으로 작성.
  · [1행 - 입지 & 스펙]: "{권역/역세권}, {규모} {자산유형} 매물 안내드립니다."
  · [2행 - 핵심 재무/운영]: "{가격대}, {포스처별 핵심 지표}" (수치 중심, 수식어 배제)
  · [3행 - 실무 클로징]: 투자 포스처(investmentPosture)에 맞는 회신 유도 문구:
    - income: "검토 후 상세 자료(IM) 및 임대차 세부 내역이 필요하시면 편하게 말씀해 주세요."
    - owner_occupied: "사옥 검토용 세부 자료 및 현장 브리핑이 필요하시면 회신 부탁드립니다."
    - development: "토지 대장 및 신축 수지 검토 자료가 필요하시면 전달드리겠습니다."
    - operating: "운영 지표(KPI/GOP) 및 위탁운영 조건 자료가 필요하시면 말씀해 주세요."
    - trading: "인근 실거래 비교표 및 매각 협상 조건이 필요하시면 회신 부탁드립니다."
  · 절대 금지 표현: "블라인드 기준", "블라인드로", "스토리가 있습니다", "수요를 흡수", "자산 구성입니다"
