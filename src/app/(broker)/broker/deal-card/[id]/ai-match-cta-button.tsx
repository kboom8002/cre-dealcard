...
export function AiMatchCtaButton({ buildingId, matchCount, topGrade }: AiMatchCtaButtonProps) {
  ...
  return (
    <button
      ...
      className={`flex items-center justify-center gap-1.5 w-full rounded-xl text-white py-3 px-3 text-xs sm:text-sm font-bold whitespace-nowrap shadow-md active:scale-[0.98] transition-all ${
        hasHighGrade
