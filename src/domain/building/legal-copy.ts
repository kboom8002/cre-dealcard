...
const LEGAL_COPIES: Record<LegalCopyType, { ko: string; en?: string }> = {
  ...
  basic_im_notice: {
    ko: '본 투자설명서(Basic IM)는 자산의 기본 정보를 제공하며, 정확한 주소 및 상세 재무 정보는 Pro IM에서 확인하실 수 있습니다. 표시된 위치는 실제 위치와 약 150m의 차이가 있을 수 있습니다.',
  },
  pro_im_notice: {
    ko: '본 투자설명서(Pro IM)는 NDA 서명을 완료한 열람자에게만 제공됩니다. 정확한 주소, 상세 재무 정보, 임대차 현황이 포함되어 있습니다. 모든 열람 기록은 추적됩니다.',
  },
  broker_compliance: {
