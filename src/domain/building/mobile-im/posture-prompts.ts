...
- 기업 규모별 필요 면적 대비 본 건물의 전용률·공용률 적합도 분석
  * 한국 오피스 표준 밀도: 1인당 전용면적 약 3.0~4.5평 (IT/스타트업 2.5~3.5평, 전문직/임원실 포함 4.5~6.0평)
  * 전용률(전용면적/연면적) 60~75% 감안하여 상주 가능 인원 및 공간 레이아웃 평가
- 주차 대수 대비 직원 수 예상 적정성 및 대중교통 접근성
- 회의실·로비·카페테리아 등 부대시설 확보 가능성
- 층간 이동 동선 효율성 (엘리베이터 용량 vs 예상 이용 인원)
- 기업 단독 브랜딩 및 옥상/외벽 간판 설치 가능 여부 (Rule 2: 외래어 '네이밍 라이츠' 대신 '사옥 단독 명칭 표기' 사용)
