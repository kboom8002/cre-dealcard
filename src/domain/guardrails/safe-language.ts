...
export const SAFE_REWRITE_MAP: Record<string, string> = {
  ...
  "원금 보장":
    "원금 손실 리스크가 존재하며, 자본시장법상 원금 보장은 제공되지 않습니다.",
  원금보장:
    "원금 손실 리스크가 존재하며, 자본시장법상 원금 보장은 제공되지 않습니다.",
  "확정 수익":
    "수익률은 운용 실적 및 시장 상황에 따라 변동되며, 확정 수치가 아닙니다.",
  확정수익:
    "수익률은 운용 실적 및 시장 상황에 따라 변동되며, 확정 수치가 아닙니다.",
  "예상 수익률":
    "예시 수치이며 변동 가능성이 상존합니다.",
  "최소 수익":
    "수익은 변동될 수 있으며, 최소 수익이 약정되지 않습니다.",
  "최저 배당":
    "배당금은 사업 실적에 따라 달라질 수 있습니다.",
  "손실 없는":
    "투자 자산의 가치 하락 및 손실 가능성이 있습니다.",
  "안정적 배당":
    "배당 수준은 제반 운용 여건에 따라 변경될 수 있습니다.",
  "배당 보장":
    "배당 지급 여부 및 금액은 운용 결과에 따라 달라지며 보장되지 않습니다.",
};
