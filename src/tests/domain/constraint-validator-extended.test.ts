...
describe('Constraint Validator — Extended Rules C05-C13', () => {
  ...
  it('C05: should warn when implied cap rate exceeds 30%', async () => {
  ...
  it('C05: should not warn for normal cap rate', async () => {
  ...
  // C06: Building Age
  it('C06: should error for future build year', async () => {
  ...
  it('C11: should error when DCF requested for non-A grade', async () => {
  ...
  it('C11: should allow DCF for grade A', async () => {
  ...
  it('C13: should warn for low-confidence fallback address', async () => {
  ...
  it('C13: should not warn for high-confidence address', async () => {
  ...
  it('C13: should not warn for non-fallback address', async () => {
