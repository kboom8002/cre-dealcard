...
- 3단계: 매매계약 체결 및 소유권 이전`,
  ...
  results.push({
    ...
    standardGrade: dangsanStdBadge.    refinedGrade: dangsanRefinedBadge.    mobileImSectionsSaved: dangsanSections.length,
  ...
  results.push({
    ...
    standardGrade: yangpyeongStdBadge.    refinedGrade: yangpyeongRefinedBadge.    mobileImSectionsSaved: yangpyeongSections.length,
