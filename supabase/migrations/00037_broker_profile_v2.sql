-- ============================================================
-- 00037: Broker Profile Enhancement — 한국 CRE 특화 필드 확장
-- ============================================================
...
-- Index for slug-based public lookup
CREATE INDEX IF NOT EXISTS idx_broker_profiles_slug ON broker_profiles(slug) WHERE slug IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_broker_profiles_public ON broker_profiles(is_public) WHERE is_public = true;

-- Allow public read of broker profiles that are marked public
